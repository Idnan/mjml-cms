...
export function completeAfter(CodeMirror: any, cm: any, pred: any) {
...
export function completeIfAfterLt(CodeMirror: any, cm: any) {
...
export function completeIfInTag(CodeMirror: any, cm: any) {
    return completeAfter(CodeMirror, cm, function () {
